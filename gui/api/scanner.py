...
async def execute_scan(
    ...
    """
    Execute a Prowler scan as an asyncio background task.

      1. Build CLI command + environment
      2. Launch prowler subprocess
      3. Stream stdout line by line → SSE + DB
      4. Detect output CSV on completion
